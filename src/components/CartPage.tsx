          ...
          {steps.map((step) => (
            <Box
              ...
              sx={{
                ...
                gap: 1,
                pb: 2,
                borderBottom: step.id === activeStep ? "2px solid black" : "1px solid gray",
                color: step.id === activeStep ? "black" : "gray",
              }}
            >
              <Box
                sx={{
            ...
            <Stack direction="column" spacing={2} sx={{ color: "gray" }}>
              ...
              >
                ...
                <Typography variant="body1" sx={{ color: "black" }}>
                  ${products.reduce((acc, item) => 2 + item.price * 3, 0)}
                </Typography>
              </Box>
              <Box
                component="div"
